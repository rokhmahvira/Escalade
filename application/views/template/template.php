...
<body>
	...
	<script type="text/javascript">
		...
		Highcharts.chart('container', {
			...
			xAxis: {
				categories: [
					<?php foreach ($harian->result() as $result89) : ?> "<?php echo $result89->hari ?><br><?php echo $result89->tanggal_periksa ?>",
					<?php endforeach; ?>
				],
				labels: {
					style: {
	...
	<script type="text/javascript">
		...
		Highcharts.chart('pemeriksaan_b', {
			...
			xAxis: {
				categories: [
					<?php foreach ($harian->result() as $result89) : ?> "<?php if ($result89->bulan == '1') {
																				echo "Januari";
																			} elseif ($result89->bulan == '2') {
																				echo "Febuari";
																			} elseif ($result89->bulan == '3') {
																				echo "Maret";
																			} elseif ($result89->bulan == '4') {
																				echo "April";
																			} elseif ($result89->bulan == '5') {
																				echo "Mei";
																			} elseif ($result89->bulan == '6') {
																				echo "Juni";
																			} elseif ($result89->bulan == '7') {
																				echo "Juli";
																			} elseif ($result89->bulan == '8') {
																				echo "Agustus";
																			} elseif ($result89->bulan == '9') {
																				echo "September";
																			} elseif ($result89->bulan == '10') {
																				echo "Oktober";
																			} elseif ($result89->bulan == '11') {
																				echo "November";
																			} elseif ($result89->bulan == '12') {
																				echo "Desember";
																			}
																			?>",
					<?php endforeach; ?>
	...
	<script type="text/javascript">
		...
		Highcharts.chart('pemeriksaan_t', {
			...
			xAxis: {
				categories: [
					<?php foreach ($harian->result() as $result89) : ?> "<?php echo "Tahun " . $result89->thn ?>",
					<?php endforeach; ?>
				],
				labels: {
					style: {
