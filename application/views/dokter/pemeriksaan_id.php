								...
								<input type='radio' class="" rows="3" name="wajah" value="Asimetri"> Asimetri
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="wajah" value="Simetri" <?= $umum->wajah == 'Simetri' ? 'checked' : null ?>> Simetri
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group ">
								...
								<div class="form-group">	
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="bibir1" value="Normal" <?= $umum->bibir == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
								...
								<input type='radio' class="" rows="3" name="submandibula_kanan2" value="Tidak Sakit" > Tidak Sakit
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kanan1" value="Teraba" <?= $umum->submandibula_kanan == 'Teraba' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Teraba,Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Teraba,Tidak Sakit' ? 'checked' : null ?>> Teraba
												</div>
											</div>
						...
						<input type='radio' class="" rows="3" name="submandibula_kiri2" value="Tidak Sakit" > Tidak Sakit
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kiri1" value="Teraba" <?= $umum->submandibula_kiri == 'Teraba' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Teraba,Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Teraba,Tidak Sakit' ? 'checked' : null ?>> Teraba
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="gingiva2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="gingiva1" value="Normal" <?= $umum->gingiva == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="debris2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="debris1" value="Normal" <?= $umum->debris == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
								...
								<input type='radio' class="" rows="3" name="stain" value="Tidak Ada" > Tidak Ada
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="stain" value="Ada" <?= $umum->stain == 'Ada' ? 'checked' : null ?>> Ada
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
								...
								<input type='radio' class="" rows="3" name="kalkulus" value="Supragingiva" > Supragingiva
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="kalkulus" value="Tidak Ada" <?= $umum->kalkulus == 'Tidak Ada' ? 'checked' : null ?>> Tidak Ada
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="mukosa2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="mukosa1" value="Normal" <?= $umum->mukosa == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="palatum2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="palatum1" value="Normal" <?= $umum->palatum == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="lidah2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="lidah1" value="Normal" <?= $umum->lidah == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="dasar_mulut2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="dasar_mulut1" value="Normal" <?= $umum->dasar_mulut == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="hubungan_rahang" value="Ortognati" <?= $umum->hubungan_rahang == 'Ortognati' ? 'checked' : null ?>> Ortognati
												</div>
											</div>
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="kelainan_gigi_geligi1" value="Normal" <?= $umum->kelainan_gigi_geligi == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
								...
								<textarea name="keterangan_khusus" class="form-control" placeholder="46 Only, vitalitas(+), perkusi(+), palpasi(-)." rows="10" ></textarea>
									...
									<?php foreach ($pemeriksaan_khusus->result() as $khusus) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-12">
												<div class="form-group">
													<textarea name="keterangan_khusus" class="form-control" placeholder="46 Only, vitalitas(+), perkusi(+), palpasi(-)." rows="10"><?= $khusus->keterangan != NULL ? $khusus->keterangan : null ?></textarea>
												</div>
											</div>
