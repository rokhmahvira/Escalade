                    ...
                    <li class="dropdown mega-dropdown"> <a href="#" class="" data-toggle=""><b>Pilih Profil</b><br><br>
                      ...
                      <ul class="dropdown-menu mega-dropdown-menu row">
                        ...
                        <li class="col-sm-6" style="list-style-type: none;">
                          ...
                          <button class="btn salmon col-sm-6" style="float: right; width: 100px; background-color:#f40049; color:white" type="button" onclick="location.href ='<?php echo base_url() ?>owner/tambah_pasien_k/<?php echo $result1->id_user ?>'">Pilih</button>
