                   ...
                   <?php foreach ($dokter->result() as $result3) : ?>
                    <li class="col-sm-6" style="list-style-type: none;">
                      <div class="col-sm-6">          
                        ...
                        <?php echo $result3->spesialis ?> &nbsp;&nbsp;
                        <span class="glyphicon glyphicon-briefcase" style="color: grey;"></span><span style="float: right;"><?php echo $result3->pengalaman ?> tahun</span>
                      </div>
