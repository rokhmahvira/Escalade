						...
						<div class="form-group">
							<div class="col-md-12">
								...
								<div class="col-lg-3" style="margin-left: 178px;">
									<div class="form-group">
										<button class="btn btn-anim" name="kirim" style="height: 50px; width: 200px; background-color: #f40049; color: white; border-radius: 15px; margin-top:10px"><span class="btn-text">Kirim Kode Verifikasi </span></button>
									</div>
								</div>
