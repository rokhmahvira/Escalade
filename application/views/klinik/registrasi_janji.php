							...
							<?php foreach ($janji->result() as $result) : ?>
								...
								<tr>
									...
									<div id="myModal<?php echo $result->id_pasien ?>" class="modal" style="top: 100px;">
										<form class="form-horizontal" action="<?php echo base_url('klinik/update_janji/'); ?>" method="post" enctype="multipart/form-data" role="form">
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														<button class="btn salmon" onclick="popUp()" type="submit"> Daftar&nbsp;</button>
									...
									<div id="ModalUbah<?php echo $result->id_pasien ?>" class="modal" style="top: 100px;">
										<form class="form-horizontal" action="<?php echo base_url('klinik/update_rencana/'); ?>" method="post" enctype="multipart/form-data" role="form">
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
													...
													<div class="modal-footer">
														...
														<button class="btn salmon" onclick="popUpBatalKonfirmasi()" type="submit"> Ubah&nbsp;</button>
														<button type="button" class="btn btn-warning" data-dismiss="modal"> Batal</button>
