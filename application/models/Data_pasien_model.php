...
class Data_pasien_model extends CI_Model
{
    ...
    {
        $this->db->select('*');
        // $this->db->select("a.hari, a.jam_mulai, a.jam_tutup, a.id_dokter");
        //$this->db->distinct('a.hari');
        $this->db->from(' jadwal_dokter a');
        $this->db->join('booking b', 'a.id_dokter=b.id_dokter');
        $this->db->where('b.id_booking', $id);
        $this->db->group_by('a.hari', 'b.id_dokter');
        // $this->db->order_by('a.hari', 'desc');
    ...
    function get_jadwal_dokter($id_dokter)
    {
        ...
        // $this->db->get_where('jadwal_dokter', array('id_dokter' => $id_dokter));
        // $this->db->t
